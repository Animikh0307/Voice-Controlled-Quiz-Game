...
class QuizGame():
    ...
    pygame.init()
    pygame.mixer.music.load("solarflex-space-495656.mp3")
    ...
    def play_sound(self):
        pygame.mixer.init()
        sound = pygame.mixer.Sound("universfield-computer-mouse-click-352734.mp3")
        channel1 = pygame.mixer.Channel(1)
        channel1.play(sound)

    def load_frames(self):
        video_path = "3194277-hd_1920_1080_30fps.mp4"
    ...
    def t2s(self):
        ...
        options = self.answers[self.index]

        speech = question_text + ". "
        speech += "Option A " + options[0].split(")")[1]
        speech += ". Option B " + options[1].split(")")[1]
        speech += ". Option C " + options[2].split(")")[1]
        speech += ". Option D " + options[3].split(")")[1]

        engine.say(speech)
        engine.runAndWait()

        threading.Thread(target=self.s2t).start()
            ...
            try:
                with sr.Microphone() as source:
                    ...
                    try:
                        ...
                        return   # stop after successful recognition
    ...
    def __init__(self, root):
        ...
        self.option_button1 = tk.Radiobutton(
            self.root,
            text=self.answers[self.index][0],
            variable=self.selected_option,
            value=self.answers[self.index][0],
            font=("Bahnschrift", 22),
            bg="black",
            fg="purple",
        ...
        self.option_button2 = tk.Radiobutton(
            self.root,
            text=self.answers[self.index][1],
            variable=self.selected_option,
            value=self.answers[self.index][1],
            font=("Bahnschrift", 22),
            bg="black",
            fg="purple",
            command=self.play_sound
        ...
        self.option_button3 = tk.Radiobutton(
            self.root,
            text=self.answers[self.index][2],
            variable=self.selected_option,
            value=self.answers[self.index][2],
            font=("Bahnschrift", 22),
            bg="black",
            fg="purple",
            command=self.play_sound
        ...
        self.option_button4 = tk.Radiobutton(
            self.root,
            text=self.answers[self.index][3],
            variable=self.selected_option,
            value=self.answers[self.index][3],
            font=("Bahnschrift", 22),
            bg="black",
            fg="purple",
            command=self.play_sound
        ...
        th1 = threading.Thread(target=self.t2s)
        th1.start()
    ...
    def check_answer(self):
        ...
        if self.count < 3:
            pygame.mixer.init()
            sound1 = pygame.mixer.Sound("Button-click-sound.mp3")
            channel1 = pygame.mixer.Channel(1)
            ...
            pygame.mixer.init()
            pygame.mixer.music.load("Game-victory-sound-effect.mp3")
    ...
    def show_final_score(self):
        ...
        if self.score == 4:
            ...
            sorry = ["Keep Going!", "Better Luck Next Time!", "Practice Makes a man Perfect!"]
